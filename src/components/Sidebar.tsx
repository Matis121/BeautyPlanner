...
const Sidebar = () => {
  return (
    <>
      <nav className="flex flex-col justify-between items-center bg-gray-200 h-screen w-26 z-50 px-2 py-5">
        <div className="flex flex-col items-center">
          ...
          <NavLink
            to="/calendar"
            className="my-4 flex flex-col justify-center items-center text-gray-700 hover:cursor-pointer hover:text-gray-500"
          >
